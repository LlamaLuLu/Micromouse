...
MAKECMD         = /Applications/MATLAB_R2025a.app/bin/maca64/gmake -j 8 -l 10
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = mm_autograde_M2_nice
MODULES                 = mm_autograde_M2_nice.c mm_autograde_M2_nice_capi.c mm_autograde_M2_nice_data.c mm_autograde_M2_nice_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = mm_autograde_M2_nice
MAKEFILE                = mm_autograde_M2_nice.mk
MATLAB_ROOT             = /Applications/MATLAB_R2025a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2025a.app
START_DIR               = /Users/llamalulu/Documents/UCT/Courses/EEE3097S/Micromouse
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 7
COMPUTER                = MACA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/Applications/MATLAB_R2025a.app" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DENABLE_SLEXEC_SSBRIDGE=1 -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DUSE_LOCALHOST -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=1" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=12.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/mm_autograde_M2_nice \
